...
class AmazonProductSpider(scrapy.Spider):
    ...
    def __init__(self):
        self.conn = sqlite3.connect('C:/Users/Kahla/OneDrive/Documents/amazon_scraper_project/db/amazon_prices.db')
    ...
    def parse(self, response, category):
        ...
        for product in products:
            ...
            url = 'https://www.amazon.com' + a_tag.css('::attr(href)').get() if a_tag else 'NaN'
    ...
    def save_to_db(self, title, category, url, price):
        self.cursor.execute("""
            ...
            VALUES (?, ?, ?, ?, ?)
        """, (title, category, url, price, str(datetime.now())))
        self.conn.commit()
